  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        <Text style={styles.headerText}>Language technologies</Text>
        <View style={styles.cardRow}>
          <CourseCard
            imageSource={python}
            title="PYTHON"
            onPress={() => navigation.navigate('Language-Technologies')}
          />
          <CourseCard
            imageSource={mern}
...
export default LanguageTechnologies
